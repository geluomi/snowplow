...
object LzoThriftSpec {
  ...
  val thriftObject = new SnowplowRawEvent(1381175274000L, "collector", "UTF-8", "255.255.255.255");
  thriftObject.setPayload(payload);
  thriftObject.setNetworkUserId("8712a379-4bcb-46ee-815d-85f26540577f")
...
class LzoThriftSpec extends Specification {
  ...
  "A job which processes a RawThrift file containing 1 valid page view" should {
    EtlJobSpec("thrift-raw", "1", true, List("geo")).
